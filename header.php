...
<!-- top bar -->
<div class="top" style="padding-bottom: 4rem">
	<div class="container" >
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo">
				<a href="index.php" class="mb-1"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"></a>
			</div>
				...
				<ul>
					...
					if(isset($_SESSION['cart_p_id'])) {
	                    ...
	                    for($i=1;$i<=count($arr_cart_p_qty);$i++) {
							$row_total_price =  (float) $arr_cart_p_current_price[$i] *  $arr_cart_p_qty[$i];
